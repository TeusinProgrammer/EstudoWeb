...
select * from tb_alunos where idade < 5;

-- Aula 404 filtros com operador like
...
-- Aula 409 Agrupando seleções de registros
...
-- Aula 410 Filtrando selecoes agrupadas
